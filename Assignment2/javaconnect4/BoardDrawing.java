...
public class BoardDrawing extends JComponent{    
    ...
    int boardSize;
    public BoardDrawing(GameState gs,int s){
        boardSize=s;
      state = gs;
      board = 
      new Rectangle(BOARD_START_X, BOARD_START_Y, BOARD_WIDTH, BOARD_HEIGHT);
     textBack =
      new Rectangle(BOARD_START_X + (BOARD_WIDTH / 2) - 100, BOARD_START_Y - 50, 200, 40);
